...
const AuthBackdrop = ({ tone = "user" }: AuthBackdropProps) => {
    ...
    <>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        <div
          className={
            isAdmin
              ? "absolute inset-0 bg-[radial-gradient(1200px_600px_at_10%_-10%,rgba(9,105,218,0.22),transparent_60%),radial-gradient(900px_500px_at_100%_0%,rgba(251,143,68,0.18),transparent_62%),radial-gradient(800px_500px_at_50%_110%,rgba(12,112,242,0.14),transparent_58%)] dark:bg-[radial-gradient(1200px_600px_at_10%_-10%,rgba(47,129,247,0.28),transparent_60%),radial-gradient(900px_500px_at_100%_0%,rgba(251,143,68,0.22),transparent_62%),radial-gradient(800px_500px_at_50%_110%,rgba(56,139,253,0.24),transparent_58%)]"
              : "absolute inset-0 bg-[radial-gradient(1200px_600px_at_10%_-10%,rgba(47,129,247,0.20),transparent_60%),radial-gradient(900px_500px_at_100%_0%,rgba(45,164,78,0.18),transparent_62%),radial-gradient(800px_500px_at_50%_110%,rgba(9,105,218,0.14),transparent_58%)] dark:bg-[radial-gradient(1200px_600px_at_10%_-10%,rgba(56,139,253,0.26),transparent_60%),radial-gradient(900px_500px_at_100%_0%,rgba(63,185,80,0.20),transparent_62%),radial-gradient(800px_500px_at_50%_110%,rgba(47,129,247,0.24),transparent_58%)]"
          }
        />
        ...
        <div
          className={`absolute -left-16 top-20 h-52 w-52 rounded-full blur-3xl ${
            isAdmin ? "bg-[#58a6ff]/30 dark:bg-[#388bfd]/35" : "bg-[#58a6ff]/30 dark:bg-[#388bfd]/35"
          }`}
          style={{ animation: "auth-float-a 12s ease-in-out infinite" }}
        />
        <div
          className={`absolute right-[-80px] top-[18%] h-72 w-72 rounded-full blur-3xl ${
            isAdmin ? "bg-[#fb8f44]/25 dark:bg-[#fb8f44]/30" : "bg-[#2da44e]/25 dark:bg-[#3fb950]/30"
          }`}
          style={{ animation: "auth-float-b 15s ease-in-out infinite" }}
        />
        <div
          className={`absolute bottom-[-110px] left-1/2 h-80 w-80 -translate-x-1/2 rounded-full blur-3xl ${
            isAdmin ? "bg-[#0969da]/22 dark:bg-[#2f81f7]/27" : "bg-[#0969da]/20 dark:bg-[#2f81f7]/25"
          }`}
